...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(url('admin/solution')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label>Nume</label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mihai.pantazi/Sites/FULLSTACK_APPS/iqDOMUS/backend/resources/views/admin/solution/create.blade.php ENDPATH**/ ?>